#ifndef FIND_CLOSEST_CELLS_H
#define FIND_CLOSEST_CELLS_H
...
namespace simulation
{
	...
	class find_closest_cells : public sim_unit_template
	{
		public:
			...
			find_closest_cells(cl::Platform & platform_cl, cl::Device & device_cl, cl::Context & context, cl::CommandQueue & command_queue);
			virtual ~find_closest_cells();
